...
- `outputs/figures/`
  Standalone chart and map exports generated by the pipeline.
- `outputs/report.html`
...
The `outputs/figures/` folder contains a curated set of standalone map and chart exports, including the region map, county heatmaps, regional comparison charts, and outreach school map.
